...
let isTrue = true;
let num = 5;
console.log(typeof name, typeof isTrue, typeof num);
...
let changeAble = "This veriable is changeable ";
changeAble = "variable change hoye geche";
const notChangeable = "variable er man change hobe na";
...
console.log(add, sub, multi, divi, remainder);
...
const less = num1 < num2; //true
const gretew = num1 > num2; //false
const soman = num1 == num2; //flase
const somanNa = num1 != num2; //true
const lessEqual = num1 <= num2; //true
const greterEqual = num1 >= num2; //false
...
if (age < 18 && age >= 14) {
  console.log("You are Not Adult But You are Growing");
...
while (odd <= 19) {
  if (odd % 2 == 1) {
    console.log("Is a Odd Number In beetWeen 7 to 19", odd);
  }
  odd++;
}
...
let arr = [1, 3, 4, 5, 6, 82, 4, 67, 3, 1, 90, 67, 89, 54, 87];

//কয়টা উপাদান আছে সেটা বের করবে হবে
const resultLength = arr.length;
...
for (const element of arr) {
  if (element > 80) {
    larger = element;
    console.log("Big Then 80 =", larger);
  }
}
...
function multiplicationThree(num1, num2, num3) {
  const multi = num1 * num2 * num3;
  return multi;
}

console.log("The result Of Multaplication is ", multiplicationThree(6, 8, 4));
